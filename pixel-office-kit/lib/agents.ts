...
export const THINK_MSGS: Record<string, string[]> = {
  main:  ['分解复杂任务...', '推演执行路径', '统筹全局规划'],
  aria:  ['用户旅程推演...', '需求优先级排序', '规划产品路线图'],
  neon:  ['构思交互方案...', '脑海中的组件树', '灵感涌现中...'],
  rex:   ['规划部署策略...', '容灾方案推演', '推导运维流程'],
  lyra:  ['分析边界情况...', '测试矩阵设计', '推导预期行为'],
  emma:  ['规划发布节奏...', '零停机思路中', '验证发布路径'],
  zeph:  ['架构草图浮现...', '系统边界思考', '抽象层级设计'],
  nova:  ['设计语言推演...', '色彩情感联想', '交互流程联想'],
};
